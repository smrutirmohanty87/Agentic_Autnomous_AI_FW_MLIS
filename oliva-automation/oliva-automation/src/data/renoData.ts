...
export const RENO_RISK_INFO = {
  ...
  expiryTime: '23:59:00',
  intermediaryReference: 'INTREF071026001',
  insurerQuotePolicyReference: 'QTEREF-AUTO001',
  submissionCurrency: 'GBP',
};

/** Insurable Detail (risk location) — image10. */
export const RENO_INSURABLE = {
  insurableName: 'PG Test Insured',
  ...
  steps: [
    ...
    // A2. Proposer Details (image13)
    {
      ...
      fields: [
        ...
        { label: 'Full Name', kind: 'text', value: 'Test Business User' },
      ],
      action: 'Next',
    },
    ...
    // Address are readonly and therefore omitted.
    {
      ...
      fields: [
        ...
        { label: 'Contract Period (Months)', kind: 'number', value: '36' },
        { label: 'Maintenance Period (Months)', kind: 'number', value: '12' },
        { label: 'Product Rating Type', kind: 'picklist', value: 'Renovation Package' },
        { label: 'Interested Parties', kind: 'text', value: 'A and B' },
        {
          label: 'What type of building contract will be used?',
          kind: 'picklist',
          value: 'JCT Building Contract for a Home owner/occupier',
        },
        {
          label:
    ...
    // A4. Renovation Cont. (image15)
    {
      ...
      fields: [
        ...
        { label: 'Flood checks returned as ok to quote?', kind: 'radio', value: 'No' },
      ],
      action: 'Next',
    },
      ...
      steps: [
        {
          ...
          fields: [
            { label: 'Sum Insured', kind: 'currency', value: '250000.00' },
            { label: 'Excess - fire', kind: 'picklist', value: '750' },
            { label: 'Excess - flood', kind: 'picklist', value: '250' },
            { label: 'Excess - water damage', kind: 'picklist', value: '100' },
            {
              label: 'Excess - all other damage or losses',
              kind: 'picklist',
              value: '500',
            },
            { label: 'Escalation Cost Limit %', kind: 'number', value: '15' },
          ],
          action: 'Save',
        },
      ],
      ...
      steps: [
        // B2.1 Existing Structures (image21)
        {
          ...
          fields: [
            ...
            { label: 'Is the building listed', kind: 'radio', value: 'Yes' },
            {
            ...
            { label: 'Wall Construction', kind: 'text', value: 'Yes' },
            { label: 'Roof Construction', kind: 'text', value: 'Yes' },
        ...
        // B2.3 Excesses (image23)
        {
          ...
          fields: [
            ...
            { label: 'Excess - water damage', kind: 'picklist', value: '500' },
            { label: 'Excess - flood', kind: 'picklist', value: '750' },
            {
              label: 'Excess - all other damage or losses',
              kind: 'picklist',
              value: '500',
      ...
      steps: [
        {
          ...
          fields: [
            ...
            { label: 'Excess - fire', kind: 'picklist', value: '100' },
            { label: 'Excess - water damage', kind: 'picklist', value: '250' },
            { label: 'Excess - flood', kind: 'picklist', value: '500' },
            {
              label: 'Excess - all other damage or losses',
              kind: 'picklist',
              value: '750',
      ...
      steps: [
        {
          ...
          fields: [
            ...
            { label: 'Contract Value', kind: 'currency', value: '4590.67' },
            { label: 'Existing Structure', kind: 'currency', value: '6798.79' },
            { label: 'DSU', kind: 'currency', value: '2315.25' },
            { label: 'ACOW', kind: 'currency', value: '1200.77' },
          ...
          fields: [
            {
              ...
              kind: 'picklist',
              value: 'New Building Construction - up to 10m or 3 storeys',
            },
            {
              label:
...
const RENO_PREMIUMS_ALL: RenoPremiumEntry[] = [
  { coverage: 'Contract Works', insurable: 'PG Test Insured', technical: '555.55', grossWritten: '555.55', annualized: '555.55', commissionRate: '5' },
  { coverage: 'Existing Structures', insurable: 'PG Test Insured', technical: '456.77', grossWritten: '456.77', annualized: '456.77', commissionRate: '5' },
  { coverage: 'Contents', insurable: 'PG Test Insured', technical: '777.01', grossWritten: '777.01', annualized: '777.01', commissionRate: '5' },
  { coverage: 'Advanced Loss of Profits/Delayed Start Up', insurable: 'PG Test Insured', technical: '467.44', grossWritten: '467.44', annualized: '467.44', commissionRate: '5' },
  { coverage: 'Own Plant', insurable: 'PG Test Insured', technical: '1233.44', grossWritten: '1233.44', annualized: '1233.44', commissionRate: '5' },
  { coverage: 'Hired in Plant', insurable: 'PG Test Insured', technical: '777.77', grossWritten: '777.77', annualized: '777.77', commissionRate: '5' },
  { coverage: 'Public & Products Liability', insurable: 'PG Test Insured', technical: '123.44', grossWritten: '123.44', annualized: '123.44', commissionRate: '5' },
  { coverage: 'Terrorism', insurable: 'PG Test Insured', technical: '111.44', grossWritten: '111.44', annualized: '111.44', commissionRate: '5' },
  { coverage: 'JCT 6.5.1 Non Negligent Liability', insurable: 'PG Test Insured', technical: '134.44', grossWritten: '134.44', annualized: '134.44', commissionRate: '5' },
];
...
/** Select Binders tab (images 39–40). */
export const RENO_BINDER = {
  // Partial name (no year) — matches the actual available binder row
  // ("Accelerant Oliva Construction 2024") regardless of year.
  name: 'Accelerant Oliva Construction',
  section: 'Renovation',
  nrToBinder: 'New Business',
};

/** Fee entry OmniScript (image50). */
export const RENO_FEE = {

  ...
  steps: [
    ...
    },
    {
      ...
      fields: [
        ...
        { label: 'maximum height worked to', kind: 'text', value: '123456789' },
        { label: 'maximum depth worked to', kind: 'text', value: '123456789' },
        { label: 'Is cover for Sub-Contractors included', kind: 'radio', value: 'Yes' },
        { label: 'application of heat', kind: 'text', value: '10' },
    ...
    },
    {
      ...
      fields: [
        { label: 'Describe the location of the Contract Site', kind: 'text', value: '22 Bishopsgate' },
        { label: 'How often will the contract site be visited', kind: 'text', value: '10' },
        ...
        { label: 'external company to oversee the health', kind: 'radio', value: 'No' },
    ...
    },
    {
      title: 'Types of Work',
      fields: [
        { label: 'timber framed buildings', kind: 'radio', value: 'No' },
        { label: 'alteration of any basements', kind: 'radio', value: 'No' },
        { label: 'Demolition of buildings', kind: 'radio', value: 'No' },
...
const CARP_INSURED = 'PG Test Insured';
...
const CARP_PREMIUMS_ALL: RenoPremiumEntry[] = [
  ...
  { coverage: 'Terrorism', insurable: CARP_INSURED, technical: '1000.51', grossWritten: '1000.51', annualized: '', commissionRate: '5' },
...
// ---------------------------------------------------------------------------
// Binder — the doc never shows the CARP binder NAME (reused Care screenshots);
// section per image35 = "Contractors All Risks - Project". The partial name
// below is provisional pending live-org confirmation.
// ---------------------------------------------------------------------------

export const CARP_BINDER = {
  name: 'Accelerant Oliva Construction',
  section: 'Contractors All Risks - Project',

...
test.describe('@regression | E2E | Cancel and Reissue | Cancellation', () => {
  test('TC_REG_019 | Create new policy then cancel and reissue then cancel the policy', async ({ page }) => {
    test.setTimeout(900000);
    test.slow();

    const caseRef = `E2E-CR-CAN-${Date.now()}`;

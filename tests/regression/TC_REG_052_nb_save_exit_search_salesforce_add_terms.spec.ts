...
test.describe('@regression | E2E | NB | Save Exit | Global Search | Add Terms', () => {
  test('TC_REG_052 | Continue to summary, save and exit, search ref on home and in Salesforce global search, add terms and save', async ({ page }) => {
    ...
    // Navigate to Related tab -> Submission Statement Of Facts -> click View All.

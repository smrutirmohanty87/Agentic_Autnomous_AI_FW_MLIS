...
test.describe('@regression | E2E | Cancellation | Cancel and Reissue | E&W', () => {
  test('TC_REG_015_EW_DOCS | Cancel and reissue a live policy (England & Wales) with issue docs assertion', async ({ page }) => {
    test.setTimeout(900000);
    test.slow();

    const caseRef = `E2E-CAN-REISSUE-EW-${Date.now()}`;

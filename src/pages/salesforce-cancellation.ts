...
export class SalesforcePortalPage {
  ...
  async login(username: string, password: string) {
    await smartFill(this.page, 'SF Username', username, { context: 'SalesforceLogin' });
    await smartFill(this.page, 'SF Password', password, { context: 'SalesforceLogin' });
    await smartClick(this.page, 'SF Log In', { context: 'SalesforceLogin' });
  ...
  async openRelatedTab() {
    ...
    await smartClick(this.page, 'SF Related tab', { context: 'Salesforce', timeoutMs: 60000 });
    await this.waitForLightningIdle();
  }
  ...
  async searchAndOpenExactFromGlobalSearchGrid(reference: string) {
    await smartClick(this.page, 'SF Global Search launcher', { context: 'SalesforceSearch', timeoutMs: 15000 });
    ...
    if (activeSearchInput === dialogSearchInput) {
      await smartFill(this.page, 'SF Dialog Search input', reference, { context: 'SalesforceSearch' });
    } else {
      await smartFill(this.page, 'SF Header Search input', reference, { context: 'SalesforceSearch' });
    }
    await activeSearchInput.press('Enter');
    await this.waitForLightningIdle();
  ...
  async searchPolicyAndOpenFromGlobalSearchGrid(policyReference: string) {
    ...
    if (activeSearchInput === dialogSearchInput) {
      await smartFill(this.page, 'SF Dialog Search input', policyReference, { context: 'SalesforceSearch' });
    } else {
      await smartFill(this.page, 'SF Header Search input', policyReference, { context: 'SalesforceSearch' });
    }
    await activeSearchInput.press('Enter');
  ...
  async openNotesAndAttachmentsFromRelatedTab() {
    ...
    await smartClick(this.page, 'SF Notes & Attachments link', { context: 'SalesforceNotesAttachments', timeoutMs: 120000 });
    await this.waitForLightningIdle();
  ...
  async openCreateMTADialog() {
    ...
    await smartClick(this.page, 'SF Create MTA', { context: 'SalesforceMTA', timeoutMs: 60000 });
    await this.waitForLightningIdle();
    ...
    if (await errorToastClose.isVisible({ timeout: 3000 }).catch(() => false)) {
      await smartClick(this.page, 'SF Toast Close', { context: 'SalesforceMTA', timeoutMs: 5000 });
      await this.page.waitForTimeout(500);
    }
  }
  ...
  async fillMTAReasonAndSave(mtaReason: string) {
    ...
    await smartClick(this.page, 'SF Flow Submit', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();
  ...
  async fillIntermediaryReference(reference: string) {
    ...
    await smartClick(this.page, 'SF Edit Intermediary Reference', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();
    ...
    await smartFill(this.page, 'SF Intermediary Reference', reference, { context: 'SalesforceMTA', timeoutMs: 30000 });
  ...
  async editMTAPremium(premiumValue: string) {
    ...
    await expect(editButton).toBeVisible({ timeout: 30000 });
    await smartClick(this.page, 'SF Edit MTA Premium', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();
    ...
    if (await spinInput.isVisible({ timeout: 5000 }).catch(() => false)) {
      await smartFill(this.page, 'SF MTA Premium (dialog)', premiumValue, { context: 'SalesforceMTA', timeoutMs: 30000 });
    } else {
    ...
    await smartClick(this.page, 'SF Dialog Save', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();

    // Close the success confirmation dialog if it remains open
    const closeButton = dialog.getByRole('button', { name: /Close/i }).first();
    if (await closeButton.isVisible({ timeout: 5000 }).catch(() => false)) {
      await smartClick(this.page, 'SF Dialog Close', { context: 'SalesforceMTA', timeoutMs: 15000 });
      await this.waitForLightningIdle();
    }
  }
  ...
  async bindMTA(bindDate?: string) {
    ...
    await smartClick(this.page, 'SF Bind MTA', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();
    ...
    if (await dateField.isVisible({ timeout: 10000 }).catch(() => false)) {
      await smartFill(this.page, 'SF Bind Effective Date', dateValue, { context: 'SalesforceMTA', timeoutMs: 30000 });
    ...
    await smartClick(this.page, 'SF Bind', { context: 'SalesforceMTA', timeoutMs: 30000 });
    await this.waitForLightningIdle();
  }

  async openCancelPolicyWizard() {
    await smartClick(this.page, 'SF Show more actions', { context: 'SalesforceCancellation', timeoutMs: 30000 });
    ...
    await smartClick(this.page, 'SF Menu Cancel Policy', { context: 'SalesforceCancellation', timeoutMs: 30000 });
  ...
  async openCancelAndReissueDialog() {
    await smartClick(this.page, 'SF Show more actions', { context: 'SalesforceCancellation', timeoutMs: 30000 });
    await expect(this.page.getByRole('menuitem', { name: 'Cancel and Reissue' })).toBeVisible({ timeout: 60000 });
    await smartClick(this.page, 'SF Menu Cancel and Reissue', { context: 'SalesforceCancellation', timeoutMs: 30000 });
    ...
    const errorToastClose = this.page.locator('button[title="Close"]:visible').first();
    if (await errorToastClose.isVisible({ timeout: 3000 }).catch(() => false)) {
      await smartClick(this.page, 'SF Toast Close', { context: 'SalesforceCancellation', timeoutMs: 5000 });
      await this.page.waitForTimeout(500);
    }
  }
  ...
  async completeCancelFromInceptionStep1(notes: string) {
    ...
    await smartFill(this.page, 'SF Cancellation Notes', notes, { context: 'SalesforceCancellation', timeoutMs: 30000 });
    await this.waitForLightningIdle();
    await smartClick(this.page, 'SF Wizard Next', { context: 'SalesforceCancellation', timeoutMs: 30000 });
  ...
  async completeCancelMidtermStep1(notes: string, cancellationDate?: string) {
    ...
    await smartFill(this.page, 'SF Cancellation Effective Date', dateValue, { context: 'SalesforceCancellation', timeoutMs: 30000 });
    await this.page.keyboard.press('Tab').catch(() => undefined);
    await this.waitForLightningIdle();
  ...
  async completePremiumStepWithTaxCalculation(cancellationPremium?: string) {
    ...
    if (typeof cancellationPremium === 'string' && cancellationPremium.trim().length > 0) {
      await smartFill(this.page, 'SF Cancellation Return Premium', cancellationPremium, { context: 'SalesforceCancellation', timeoutMs: 30000 });
      await this.page.keyboard.press('Tab').catch(() => undefined);
      await this.waitForLightningIdle();
    }
    ...
    await smartClick(this.page, 'SF Calculate Tax', { context: 'SalesforceCancellation', timeoutMs: 30000 });
  ...
  async completePremiumStepCalculateTaxOkAndNext(cancellationPremium?: string) {
    ...
    await smartClick(this.page, 'SF Wizard Next', { context: 'SalesforceCancellation', timeoutMs: 60000 });
  ...
  private async acceptTaxDialogIfPresent() {
    ...
    if (await dialogContainer.isVisible({ timeout: 5000 }).catch(() => false)) {
      if (await okButton.isVisible({ timeout: 5000 }).catch(() => false)) {
        await smartClick(this.page, 'SF OK', { context: 'SalesforceCancellation', timeoutMs: 15000 });
      }
  ...
  async completeCancelAndReissueDialog(data: {
    ...
    if (data.description) {
      ...
      await smartFill(this.page, 'SF Cancel & Reissue Description', data.description, { context: 'SalesforceCancelReissue', timeoutMs: 30000 });
    }

    // Click Submit
    const submitButton = this.page.locator('[role="dialog"]:visible').getByRole('button', { name: 'Submit' });
    await expect(submitButton).toBeVisible({ timeout: 10000 });
    await smartClick(this.page, 'SF Cancel & Reissue Submit', { context: 'SalesforceCancelReissue', timeoutMs: 30000 });
    await this.waitForLightningIdle();
  }
  ...
  async completeReissueFinalPolicyDetails() {
    ...
    await smartClick(this.page, 'SF Proceed', { context: 'SalesforceCancelReissue', timeoutMs: 30000 });
    await this.waitForLightningIdle();
  }
  ...
  async completeReissueSummary() {
    ...
    await smartClick(this.page, 'SF Reissue Order', { context: 'SalesforceCancelReissue', timeoutMs: 30000 });
    await this.waitForLightningIdle();
  }
